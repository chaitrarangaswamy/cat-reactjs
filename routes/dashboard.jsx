...
//import ProjectDashboard from "../views/ProjectDashboard/Dashboard";
//import ProjectRelease from "../views/ProjectRelease/ProjectRelease";
import MetaData from "../views/MetaData/Dashboard";
import UploadMetaData from "../views/MetaData/uploadMetaData/UploadMetaData";
...
{ 
  ...
  {
    path: "/builddetails/:jobName/:buildReference/:type",
    name: "Build Details",
    icon: DateRange,
